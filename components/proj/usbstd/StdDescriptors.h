...
{
	USB_Descriptor_Header_t Header; /**< Descriptor header, including type and size. */
	wchar_ts UnicodeString[]; /**< String data, as unicode characters (alternatively,
...
typedef struct
{
	...
	u8 bDescriptorType; /**< Type of the descriptor, either a value in \ref USB_DescriptorTypes_t
	                          ...
	                          */
	wchar_ts bString[]; /**< String data, as unicode characters (alternatively, string language IDs).
