...
int lock_service_init(lock_init_t *p_config)
{
    ...
    mible_gatts_srv_db_t *p_lock_service = (mible_gatts_srv_db_t*) malloc( sizeof(mible_gatts_srv_db_t) ); 
    mible_gatts_char_db_t *p_lock_char = (mible_gatts_char_db_t *) malloc( CHAR_NUMS * sizeof(mible_gatts_char_db_t) );
